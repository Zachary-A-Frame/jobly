...
router.get("/", async function (req, res, next) {
  // We'll be using a query string to collect our data.
  // Example: localhost:3001/companies?minEmployees=0&maxEmployees=100&name=pugh =>
  // Response: {
//   "companies": [
//     {
//       "handle": "pugh-ltd",
...
// }
  ...
  //  Console log here for debugging purposes.
  // console.log(q)
  try {
